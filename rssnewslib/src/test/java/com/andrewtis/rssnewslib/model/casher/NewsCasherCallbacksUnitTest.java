...
public class NewsCasherCallbacksUnitTest {


    public NewsCasherCallbacksUnitTest(CollectorCallbackTester collectorCallbackTester, HashMap<String, StubNewsExtractor> urlExtractors) {
